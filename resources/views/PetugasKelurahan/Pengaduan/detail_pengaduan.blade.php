  ...
  @component('components.p-k.breadcrumb')
    @slot('breadcrumb_title')
      <h3>
        Detail Pengaduan</h3>
    @endslot
    <li class="breadcrumb-item"><a href="{{ route('petugaskelurahan.pengaduan.index')}}">Pengaduan</a></li>
          ...
          <div class="blog-box blog-details">
           ...
           @if($fasilitas->foto_fasilitas == null)
            ...
            <div class="card">
              ...
              href="{{ route('petugaskelurahan.fasilitasrw.edit', $fasilitas->id_fasilitas_umum) }}"><span
                class="fa fa-edit"></span>Edit</a>
            {{-- END TOMBOL EDIT --}}

            <form method="POST" action="{{ route('petugaskelurahan.fasilitasrw.destroy', $fasilitas->id_fasilitas_umum) }}"
                  class="d-inline">
                  @csrf
                  @method('DELETE')
