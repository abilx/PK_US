    ...
    <div class="row">
                        ...
                        <table class="display" id="tabelpengaduan-warga">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="" onclick="detail({{ $dt->id_pengaduan }}, '{{ route('pk.pengaduan.show',$dt->id_pengaduan)}}')"
                                            class="btn btn-success btn-sm p-2" role="button" data-bs-toggle="modal"
                                            data-original-title="test" data-bs-target="#exampleModal"><span class="fa fa-pencil fa-fw">Balas</span></a>
                                            {{-- @if ($dt->ditampilkan == '0')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid bd-example-row">
                        ...
                        <div class="row tanggap_rt pb-2">
                            <div class="col-md-3">
                                <p class="f-w-600">Tanggapan RW</span>
                            </div>
                            <div class="col-md-9 ml-auto">
                                <form action="{{ route('pk.pengaduan.tanggapin') }}" method="POST">
                                    @csrf
                                    @method('POST')
                                    <input type="hidden" name="id_validasi" value="{{ $dt->id_pengaduan }}" />
                                    <textarea class="form-control" name="tanggapan_rw" id="tanggapan_rw" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: "{{ route('pk.pengaduan.ditampilkan') }}",
                data: {
                    'ditampilkan': status,
