                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><div class="checkbox checkbox-solid-primary">
                                            ...
                                            <label for="{{ $loop->iteration }}">&nbsp;</label>{{ route('petugaskelurahan.pembayaran.store') }}
                                        </div></td>
                                    </tr>
                                    @endforeach
                            ...
                            <h4 id="result"></h4>
                        <form action="{{ route('petugaskelurahan.pembayaran.store') }}" method="post">
                            @csrf
    ...
    <script>
        $(document).ready(function() {
            $('#submit').on('click', function() {
                ...
                $.ajax({
                method: "POST",
                url: `{{ route('petugaskelurahan.pembayaran.store') }}`,
