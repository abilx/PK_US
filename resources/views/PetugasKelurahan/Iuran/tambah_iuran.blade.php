...
@component('components.p-k.breadcrumb')
        ...
        <h3>Iuran</h3>
        @endslot
        <li class="breadcrumb-item"><a href="{{ route('petugaskelurahan.iuran.index') }}">Iuran</a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <form class="form theme-form" name="f1" method="POST" action="{{ route('petugaskelurahan.iuran.store') }}">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
