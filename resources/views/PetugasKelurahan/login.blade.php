...
<html lang="en">
    ...
    <head>
        ...
        <title>Digirute | Login Petugas Kelurahan</title>
        <!-- Google font-->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="login-card">
                        <form class="theme-form login-form" method="POST" action="{{ route('pk.check-login') }}">
                            @csrf
                            <h4>Login Petugas Kelurahan</h4>
                            <h6>Selamat Datang Petugas Kelurahan Kelurahan Umban Sari.</h6>
