                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($s->status_surat == 3)
                                                    <span class="badge badge-secondary">Disetuji petugaskelurahan</span>
                                            ...
                                            <td class="aksi">
                                                <a class="btn btn-success btn-sm p-2 m-1"
                                                    href="{{ route('petugaskelurahan.surat.detail.surat_keterangan', $s->id_surat) }}"><span
                                                ...
                                                {{-- @if ($s->status_tandatangan == 1 && $s->status_surat == 4 && $s->nomor_surat != null)
                                                    <a class="btn btn-secondary btn-sm p-2 m-1"
                                                        href="{{ route('petugaskelurahan.surat.print.surat_keterangan', $s->id_surat) }}"><span
                                                            class="fa fa-print"></span></a>
                                                @endif --}}
                                                @if ($s->status_surat != 0 && $s->nomor_surat != null)
                                                    @if (!$s->status_surat == 4)
                                                        <form method="POST"
                                                            action="{{ route('petugaskelurahan.surat.terima.surat_keterangan', $s->id_surat) }}"
                                                            class="d-inline">
                                                            @csrf
                                                            @method('PUT')
