...
<body>
    <div class="m-3">
        ...
        <p>Kami Ketua RT. {{ $surat->rt->no_rt }} PetugasKelurahan. {{ $surat->petugaskelurahan->no_petugaskelurahan }},
        ...
        <div style="width:50%; text-align: center; float: left;">
            <p class="m-0">&nbsp;</p>
            <p class="mb-1">Ketua PetugasKelurahan. {{ $surat->petugaskelurahan->no_petugaskelurahan }}</p>
              <p><img class="mt-0" src="data:image/png;base64, {!! $surat->ttdpetugaskelurahan  !!}"></p>
            <p>{{ $surat->petugaskelurahan->identitas_petugaskelurahan->nama_lengkap }}</p>
        </div>
        <div style="width:50%; text-align: center; float: right;">
            <p class="m-0">Pekanbaru, {{ $tanggal->isoFormat('D MMMM Y') }}</p>
            <p class="mb-1">Ketua RT. {{ $surat->rt->no_rt }} PetugasKelurahan. {{ $surat->petugaskelurahan->no_petugaskelurahan }}</p>
