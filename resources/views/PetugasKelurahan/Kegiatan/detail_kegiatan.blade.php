  ...
  @component('components.p-k.breadcrumb')
    @slot('breadcrumb_title')
      <h3>
        Detail Kegiatan</h3>
    @endslot
    <li class="breadcrumb-item"><a href="{{ route('pk.kegiatan.index') }}">Kegiatan</a></li>
            ...
            <div class="card">
              ...
              <div class="card-footer text-end">
                ...
                <a class="btn btn-secondary btn-lg"
                  href="{{ route('pk.kegiatan.edit', $kegiatan->id_kegiatan) }}"><span
                    class="fa fa-edit"></span>Edit</a>
                {{-- END TOMBOL EDIT --}}

                {{-- TOMBOL DELETE --}}
                <form method="POST" action="{{ route('pk.kegiatan.destroy', $kegiatan->id_kegiatan) }}"
                  class="d-inline">
                  @csrf
                  @method('DELETE')
  ...
  <script>
    $('#ubah_status').click(function() {
      ...
      $.ajax({
        type: "GET",
        dataType: "json",
        url: "{{ route('pk.kegiatan.update.status') }}",
        data: {
