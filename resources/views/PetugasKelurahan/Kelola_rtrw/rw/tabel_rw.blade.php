                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="bookmark">
                                    ...
                                    <a class="btn btn-primary btn-lg" href="{{ route('pk.rw.create') }}" data-bs-original-title="" title=""> <span class="fa fa-plus-square"></span> Tambah RW</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="display" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info btn-sm p-2" href="/PK/rw/{{ $rw->id_rw }}"><span
                                                class="fa fa-eye"></span></a>
                                            <a class="btn btn-success btn-sm p-2" href="rw/{{ $rw->id_rw }}/edit"><span class="fa fa-pencil"></span></a>
                                            <form method="POST" action="{{ route('pk.rw.destroy', $rw->id_rw)}}" class="d-inline">
                                                @csrf
