...
@component('components.p-k.breadcrumb')
        ...
        <h3>RW</h3>
        @endslot
        <li class="breadcrumb-item"><a href="{{ route('pk.rw.index') }}">RW</a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <form class="form theme-form" name="f1" method="POST" action="{{ route('pk.rw.store')}}">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('no_rw') is-invalid @enderror" name="no_rw" id="no_rw" type="number" autofocus value="{{ old('no_rw') }}"/>
                                        @error('no_rw')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
