                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="bookmark">
                                    ...
                                    <a class="btn btn-primary btn-lg" href="{{ route('pk.rt.create') }}" data-bs-original-title="" title=""> <span class="fa fa-plus-square"></span> Tambah RT</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="display" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="aksi">
                                            <a class="btn btn-info btn-sm p-2" href="/PK/rt/{{ $rt->id_rt }}"><span
                                                class="fa fa-eye"></span></a>
                                            <a class="btn btn-success btn-sm p-2" href="rt/{{ $rt->id_rt }}/edit"><span class="fa fa-pencil"></span></a>
                                            <form method="POST" action="{{ route('pk.rt.destroy', $rt->id_rt)}}" class="d-inline">
                                                @csrf
