...
<h3>
    Detail Fasilitas</h3>
    @endslot
    <li class="breadcrumb-item"><a href="{{ route('pk.fasilitas.index')}}">Fasilitas</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="blog-details">
                                    ...
                                    <li class="middle">Kategori :<a href="/PK/fasilitas?category={{ $fasilitas->kategori_fasilitas_umum }}"> {{ $fasilitas->fasilitas_umumss->kategori_fasilitas }}</a></li>
                                </ul>
                                <h4>
                            ...
                            <div class="card-footer text-end">
                                ...
                                href="{{ route('pk.fasilitas.edit', $fasilitas->id_fasilitas_umum) }}"><span
                                class="fa fa-edit"></span>Edit</a>
                                {{-- END TOMBOL EDIT --}}

                                <form method="POST" action="{{ route('pk.fasilitas.destroy', $fasilitas->id_fasilitas_umum) }}"
                                    class="d-inline">
                                    @csrf
                                    @method('DELETE')
