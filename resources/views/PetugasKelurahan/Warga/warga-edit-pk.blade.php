...
@section('container')
  @component('components.p-k.breadcrumb')
    ...
    @endslot
    <li class="breadcrumb-item"><a href="{{ route('pk.warga.index')}}">Warga</a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="alert alert-danger dark alert-dismissible fade show" role="alert"><strong>Terjadi kesalahan</strong>
                  ...
                  @endif
                <div class="card">
                    <form class="form theme-form" method="POST" enctype="multipart/form-data" action="{{ route('rw.warga.update',$warga->id_warga)}}">
                        @csrf
                        @method('put')
