                    ...
                    <tr>
                      ...
                      <td class="aksi">
                        <a class="btn btn-info btn-sm p-2"
                          href="{{ route('pk.warga.show_warga',$dw->id_warga) }}"><span class="fa fa-eye"></span></a>
                        <a class="btn btn-secondary btn-sm p-2"
                          href="{{ route('pk.warga.edit', $dw->id_warga) }}"><span class="fa fa-edit"></span></a>
                        <form method="POST"
                          action="{{ route('pk.warga.destroy', $dw->id_warga) }}"
                          class="d-inline">
                          @csrf
                          <input name="_method"
                            type="hidden"
