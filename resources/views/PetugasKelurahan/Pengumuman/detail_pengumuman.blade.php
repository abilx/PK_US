...
@section('container')
  @component('components.p-k.breadcrumb')
    ...
    @endslot
    <li class="breadcrumb-item"><a href="{{ route('pk.pengumuman.index') }}">Pengumuman</a></li>
            ...
            <div class="card">
              ...
              <div class="card-footer text-end">
                ...
                <a class="btn btn-secondary btn-lg"
                  href="{{ route('pk.pengumuman.edit', $pengumuman->id_pengumuman) }}"><span
                    class="fa fa-edit"></span>Edit</a>
                {{-- END TOMBOL EDIT --}}

                {{-- TOMBOL DELETE --}}
                <form method="POST" action="{{ route('pk.pengumuman.destroy', $pengumuman->id_pengumuman) }}"
                  class="d-inline">
                  @csrf
                  @method('DELETE')
