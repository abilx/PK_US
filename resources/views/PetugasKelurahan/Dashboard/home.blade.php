...
<div class="col-xl-6 xl-100 box-col-12">
    ...
    <script>
        function test() {
            window.location = '/PetugasKelurahan/warga';
        }
    </script>
    <script>
        function test1() {
            window.location = '/PetugasKelurahan/wargarw/tetaprw';
        }
    </script>
    <script>
        function test2() {
            window.location = '/PK/warga/wargalansia';
        }
    </script>
    <script>
        function test3() {
            window.location = '/PetugasKelurahan/wargarw/wargakk';
        }
    </script>
    <script>
        function test4() {
            window.location = '/PetugasKelurahan/wargarw/wargam';
        }
    </script>
    <script>
        function test5() {
            window.location = '/PetugasKelurahan/surat';
        }
    </script>
    <script>
        function test6() {
            window.location = '/PetugasKelurahan/pengaduan';
        }
    </script>
