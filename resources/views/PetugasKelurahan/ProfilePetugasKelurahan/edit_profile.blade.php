...
@component('components.p-k.breadcrumb')
        ...
        <h3>Profile</h3>
        @endslot
        {{-- <li class="breadcrumb-item"><a href="{{ route('pk.profile.show',$pk->id_pk) }}">Profile-pk</a></li> --}}
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="alert alert-danger dark alert-dismissible fade show" role="alert"><strong>Terjadi kesalahan</strong>
              ...
              @endif
              <div class="card">
                <form class="form theme-form" method="post" action="{{ route('pk.profile.update',$warga->id_warga) }}">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" id="rw" name="rw" readonly placeholder="RW" value="{{ auth()->user() }}">
                                    </div>
                                </div>
                                <div class="mb-3 row">
