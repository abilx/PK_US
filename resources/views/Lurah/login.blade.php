...
<html lang="en">
    ...
    <head>
        ...
        <title>Digirute | Login Lurah</title>
        <!-- Google font-->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="login-card">
                        <form class="theme-form login-form" method="POST" action="{{ route('lurah.check-login') }}">
                            @csrf
                            <h4>Login Lurah</h4>
                            <h6>Selamat Datang Lurah Kelurahan Umban Sari.</h6>
