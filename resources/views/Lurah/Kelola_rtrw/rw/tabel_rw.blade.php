                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="bookmark">
                                    ...
                                    <a class="btn btn-primary btn-lg" href="{{ route('lurah.rw.create') }}" data-bs-original-title="" title=""> <span class="fa fa-plus-square"></span> Tambah RW</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('lurah.rw.destroy', $rw->id_rw)}}" class="d-inline">
                                                @csrf
