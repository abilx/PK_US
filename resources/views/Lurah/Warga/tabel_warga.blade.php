                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="row">
                            ...
                            {{-- <div class="col-3">
                                <div class="bookmark">
                                    <a class="btn btn-primary btn-lg" href="{{ route('lurah.warga.create') }}"
                    ...
                    <div class="card-body">
                        <div class="table-responsive overflow-hidden">
                            <table class="display" id="tabelwarga-lurah">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama</th>
                                ...
                                <tbody>
                                    @foreach ($warga as $dw)
                                        <tr>
                                            ...
                                            <td>{{ $dw->rt_rel->no_rt }}</td>
                                            <td>{{ $dw->nik }}</td>
                                            <td>{{ $dw->alamat }}</td>
                                            <td>{{ $dw->no_hp_warga }}</td>
                                            <td class="aksi">
                                                <a class="btn btn-info btn-sm p-2"
                                                    href="{{ route('lurah.warga.show_warga', $dw->id_warga) }}"><span
                                                        class="fa fa-eye"></span></a>
                                                {{-- <a class="btn btn-secondary btn-sm p-2"
                                                    href="{{ route('lurah.warga.edit', $dw->id_warga) }}"><span
