                ...
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-3">
                                <div class="bookmark">
                                    ...
                                    <a class="btn btn-primary btn-lg" href="{{ route('lurah.wargamiskin.create') }}"
                    ...
                    <div class="card-body">
                        <div class="table-responsive overflow-hidden">
                            <table class="display" id="tabel-kemiskinan-lurah">
                                <thead>
                                ...
                                <tbody>
                                    @foreach ($kemiskinan as $p)
                                        <tr>
                                            ...
                                            <td class="aksi">
                                                <a class="btn btn-info btn-sm p-2" href="{{ route('lurah.warga.show_warga', $p->id) }}">
                                                    <span class="fa fa-eye"></span>
                                                </a>
                                                {{-- <form method="POST"
                                                    action="{{ route('lurah.wargamiskin.destroy', $p->id) }}"
                                                    class="d-inline">
                                                    @csrf
...
@push('scripts-custom')
    <script>
        $('#tabel-kemiskinan-lurah').DataTable();
    </script>
@endpush
