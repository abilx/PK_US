...
@section('container')
  @component('components.lurah.breadcrumb')
    ...
    <li class="breadcrumb-item active">Daftar Warga Lansia</li>
  @endcomponent
  <!-- Form Tambah Warga -->
      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          <div class="card-header pb-0">
            <div class="row">
              <div class="col-9">
                <h5>Data Warga Lansia</h5>
              </div>
              {{-- <div class="col-3">
                <div class="bookmark">
                  <a class="btn btn-primary btn-lg"
                    href="{{ route('lurah.warga.create') }}"
                    data-bs-original-title=""
                    ...
                    <tr>
                      ...
                      <td class="aksi">
                        <a class="btn btn-info btn-sm p-2"
                          href="{{ route('lurah.warga.show_warga',$dw->id_warga) }}"><span class="fa fa-eye"></span></a>
                        {{-- <a class="btn btn-secondary btn-sm p-2"
                          href="{{ route('lurah.warga.edit', $dw->id_warga) }}"><span class="fa fa-edit"></span></a>
                        <form method="POST"
                          action="{{ route('lurah.warga.destroy', $dw->id_warga) }}"
                          class="d-inline">
                          @csrf
                          <input name="_method"
                            type="hidden"
