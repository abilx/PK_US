...
@section('container')
  @component('components.lurah.breadcrumb')
    ...
    @endslot
    <li class="breadcrumb-item"><a href="{{ route('lurah.pengumuman.index') }}">Pengumuman</a></li>
            ...
            <div class="card">
              ...
              <div class="card-footer text-end">
                ...
                <button class='btn @php echo $pengumuman->status_pengumuman == 0 ? 'btn-success' : 'btn-warning' @endphp
                  ...
                  href="{{ route('lurah.pengumuman.edit', $pengumuman->id_pengumuman) }}"><span class="fa fa-edit"></span>
                  {{ $pengumuman->status_pengumuman == 0 ? 'Aktif' : 'Non-Aktif' }}</button>
                {{-- END TOMBOL AKTIF NON AKTIF --}}

                {{-- TOMBOL EDIT --}}
                <a class="btn btn-secondary btn-lg"
                  href="{{ route('lurah.pengumuman.edit', $pengumuman->id_pengumuman) }}"><span
                    class="fa fa-edit"></span>Edit</a>
                {{-- END TOMBOL EDIT --}}

                {{-- TOMBOL DELETE --}}
                <form method="POST" action="{{ route('lurah.pengumuman.destroy', $pengumuman->id_pengumuman) }}"
                  class="d-inline">
                  @csrf
                  @method('DELETE')
