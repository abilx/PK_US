...
@component('components.r-w.breadcrumb')
        ...
        <li class="breadcrumb-item active">Profile-lurah</li>
    @endcomponent
	                ...
	                <div class="card profile-header">
	                    ...
	                    <div class="userpro-box">
	                        <div class="img-wrraper">
	                            @if($lurah->identitas_lurah->foto_warga == 'no-image.png')
	                            <div class="avatar"><img class="img-fluid" alt="" src="{{ asset('assets/images/dashboard/1.png') }}" /></div>
								@else
								<div class="avatar"><img class="img-fluid" alt="" src="{{ asset('storage/' . $lurah->identitas_lurah->foto_warga) }}" /></div>
								@endif
	                            <a class="icon-wrapper" href="{{route('lurah.profile.edit',$lurah->id_lurah)}}"><i class="icofont icofont-pencil-alt-5"></i></a>
	                        </div>
	                        <div class="user-designation">
	                            <div class="title">
	                                <a target="_blank" href="">
	                                    <h4>{{ $lurah->identitas_lurah->nama_lengkap }}</h4>
	                                    <h6>Lurah {{ $lurah->no_lurah }}</h6>
	                                </a>
	                            </div>
	                        </div>
	                    </div>
	                        ...
	                        <div class="col-xl-12">
	                            <div class="card">
	                                    ...
	                                    <div class="card-body post-about">
	                                        <ul>
                                                <li>
                                                    ...
                                                    <div>
                                                        <h5>{{ $lurah->identitas_lurah->nik }}</h5>
                                                        <p>NIK</p>
                                                    </div>
                                                </li>
	                                            <li>
	                                                ...
	                                                <div>
	                                                    <h5>{{ $lurah->identitas_lurah->email_warga }}</h5>
                                                        <p>email</p>
	                                                </div>
	                                            </li>
	                                            <li>
	                                                ...
	                                                <div>
	                                                    <h5>{{ $lurah->identitas_lurah->no_hp_warga }}</h5>
                                                        <p>nomor hp</p>
	                                                </div>
	                                            </li>
	                                            <li>
	                                                ...
	                                                <div>
	                                                    <h5>{{ $lurah->identitas_lurah->alamat }}</h5>
                                                        <p>alamat</p>
	                                                </div>
	                                            </li>
	                                            <li>
	                                                ...
	                                                <div>
	                                                    <h5>{{ $lurah->identitas_lurah->kode_pos }}</h5>
	                                                    <p>kode pos</p>
	                                                </div>
	                                            </li>
	                                        </ul>
	                                ...
	                                <div class="collapse" id="collapseicon3" aria-labelledby="collapseicon3" data-parent="#accordion">
										<div class="col-xl-12">
											<form class="card" method="post" action="/Lurah/profile/{{ $lurah->id_lurah }}">
												@method('PUT')
                        						@csrf
												<input type="hidden" name="id" value="{{ $lurah->id_lurah }}">
													<div class="card-body">
														<div class="row">
															<div class="col-md-12">
																<div class="mb-3">
																	<input class="form-control" name="username" value="{{ $lurah->username }}" type="text" placeholder="username" />
																</div>
												...
												<input type="hidden" name="id" value="{{ $lurah->id_lurah }}">
													<div class="card-body">
														<div class="row">
															<div class="col-md-12">
																<div class="mb-3">
																	<input class="form-control" name="password" value="{{ $lurah->password }}" type="password" placeholder="password" />
																</div>
																<div class="col-md-3 text-end">
																<button class="btn btn-primary" type="submit">Ubah</button>
															</div>
