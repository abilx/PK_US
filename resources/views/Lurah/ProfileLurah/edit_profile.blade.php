...
@component('components.r-w.breadcrumb')
        ...
        <h3>Profile</h3>
        @endslot
        <li class="breadcrumb-item"><a href="{{ route('lurah.profile.show',$lurah->id_lurah) }}">Profile-Lurah</a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="alert alert-danger dark alert-dismissible fade show" role="alert"><strong>Terjadi kesalahan</strong>
              ...
              @endif
              <div class="card">
                <form class="form theme-form" method="post" action="{{ route('lurah.profile.update',$warga->id_warga) }}">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" id="lurah" name="lurah" readonly placeholder="Lurah" value="{{ auth()->user()->no_lurah }}">
                                    </div>
                                </div>
                                <div class="mb-3 row">
