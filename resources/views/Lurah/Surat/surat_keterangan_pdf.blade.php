...
<body>
    <div class="m-3">
        ...
        <p>Kami Ketua RT. {{ $surat->rt->no_rt }} Lurah. {{ $surat->lurah->no_lurah }},
        ...
        <div style="width:50%; text-align: center; float: left;">
            <p class="m-0">&nbsp;</p>
            <p class="mb-1">Ketua RW. {{ $surat->lurah->no_lurah }}</p>
              <p><img class="mt-0" src="data:image/png;base64, {!! $surat->ttdlurah  !!}"></p>
            <p>{{ $surat->lurah->identitas_lurah->nama_lengkap }}</p>
        </div>
        <div style="width:50%; text-align: center; float: right;">
            <p class="m-0">Pekanbaru, {{ $tanggal->isoFormat('D MMMM Y') }}</p>
            <p class="mb-1">Ketua RT. {{ $surat->rt->no_rt }} Lurah. {{ $surat->lurah->no_lurah }}</p>
