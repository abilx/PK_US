                            ...
                            <div class="table-responsive overflow-hidden">
                                ...
                                <table class="display" id="tabelpengaduan-warga">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            <a href="" onclick="detail({{ $dt->id_pengaduan }}, '{{ route('lurah.pengaduan.show',$dt->id_pengaduan)}}')"
                                                class="btn btn-success btn-sm p-2" role="button" data-bs-toggle="modal"
                                                data-original-title="test" data-bs-target="#exampleModal"><span class="fa fa-list"></span></a>
                                            {{-- @if ($dt->ditampilkan == '0')
        ...
        <div class="modal-dialog  modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid bd-example-row">
                        ...
                        <div class="row mb-3 pb-2"
                            style="border-bottom: 1px solid #dee2e696;">
                            <div class="col-md-3">
                                <p class="f-w-600">Tanggapan</span>
                            </div>
                            <div class="col-md-9 ml-auto" id="tanggapan_pengaduan"></div>
                        </div>
                        <div class="row mb-3 pb-2"
                            style="border-bottom: 1px solid #dee2e696;">
                            <div class="row pb-2">
                ...
                {{-- <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="update">Confirm</button>
                </div> --}}
            </div>
        </div>
    </div>
        ...
        $('#tabelpengaduan-warga').DataTable();
         ...
         const detail = (id,url) => {
            ...
            const tanggal_pengaduan = document.getElementById('tanggal_pengaduan');
              const tanggapan_pengaduan = document.getElementById('tanggapan_pengaduan');
         ...
         const gambar_link = document.getElementById('gambar_link');
            ...
            fetch(url)
                ...
                tanggapan_pengaduan.textContent = data.tanggapan_pengaduan;
