  ...
  @component('components.warga.breadcrumb')
    @slot('breadcrumb_title')
      <h3>
        Detail Pengaduan</h3>
    @endslot
    <li class="breadcrumb-item"><a href="{{ route('lurah.pengaduan.index')}}">Pengaduan</a></li>
          ...
          <div class="blog-box blog-details">
           ...
           @if($fasilitas->foto_fasilitas == null)
            ...
            <div class="card">
              <div class="card-body">
                <div class="blog-details">
                  <ul class="blog-social">
                    ...
                    <li class="middle">Kategori :<a href="/Lurah/fasilitasrw?category={{ $fasilitas->kategori_fasilitas_umum }}"> {{ $fasilitas->fasilitas_umumss->kategori_fasilitas }}</a></li>
                  </ul>
                  <h4>
              ...
              href="{{ route('lurah.fasilitasrw.edit', $fasilitas->id_fasilitas_umum) }}"><span
                class="fa fa-edit"></span>Edit</a>
            {{-- END TOMBOL EDIT --}}

            <form method="POST" action="{{ route('lurah.fasilitasrw.destroy', $fasilitas->id_fasilitas_umum) }}"
                  class="d-inline">
                  @csrf
                  @method('DELETE')
