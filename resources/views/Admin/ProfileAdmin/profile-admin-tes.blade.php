	                ...
	                <div class="card profile-header">
	                    ...
	                    <div class="userpro-box">
	                        <div class="img-wrraper">
	                            {{-- @if($user->identitas_rw->foto_warga == 'no-image.png')
	                            <div class="avatar"><img class="img-fluid" alt="" src="{{ asset('assets/images/dashboard/1.png') }}" /></div>
								@else
								<div class="avatar"><img class="img-fluid" alt="" src="{{ asset('storage/' . $user->identitas_rw->foto_warga) }}" /></div>
								@endif --}}
	                            <a class="icon-wrapper" href="{{route('rw.profile.edit',$user->id)}}"><i class="icofont icofont-pencil-alt-5"></i></a>
	                        </div>
	                        <div class="user-designation">
	                            <div class="title">
	                                <a target="_blank" href="">
	                                    {{-- <h4>{{ $user->identitas_rw->nama_lengkap }}</h4>
	                                    <h6>RW {{ $user->no_rw }}</h6> --}}
	                                </a>
	                            </div>
	                        </div>
	                        ...
	                        <div class="col-xl-12">
	                            <div class="card">
	                                    ...
	                                    <div class="card-body post-about">
	                                        <ul>
	                                            ...
	                                            <li>
	                                                ...
	                                                <div>
	                                                    {{-- <h5>{{ $user->identitas_rw->email_warga }}</h5> --}}
                                                        <p>email</p>
	                                                </div>
	                                            </li>
	                                            <li>
	                                                ...
	                                                <div>
	                                                    {{-- <h5>{{ $user->identitas_rw->no_hp_warga }}</h5> --}}
                                                        <p>nomor hp</p>
	                                                </div>
	                                            </li>
	                                            <li>
	                                                ...
	                                                <div>
	                                                    {{-- <h5>{{ $user->identitas_rw->alamat }}</h5> --}}
                                                        <p>alamat</p>
	                                                </div>
	                                            </li>
	                                            <li>
	                                                ...
	                                                <div>
	                                                    {{-- <h5>{{ $user->identitas_rw->kode_pos }}</h5> --}}
	                                                    <p>kode pos</p>
	                                                </div>
	                                            </li>
	                                        </ul>
	                                ...
	                                <div class="collapse" id="collapseicon3" aria-labelledby="collapseicon3" data-parent="#accordion">       
										<div class="col-xl-12">
											<form class="card" method="post" action="profile/{{ $user->id }}">
												@method('PUT')  
                        						@csrf
												...
												<input type="hidden" name="id" value="{{ $user->id }}">
													<div class="card-body">
														<div class="row">
															<div class="col-md-12">
																<div class="mb-3">
																	<input class="form-control" name="password" value="{{ $user->password }}" type="password" placeholder="password" />
																</div>
																<div class="col-md-3 text-end">
																<button class="btn btn-primary" type="submit">Ubah</button>
															</div>
