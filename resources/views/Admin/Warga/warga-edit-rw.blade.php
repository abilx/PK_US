git @extends('layouts.main-admin')
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="alert alert-danger dark alert-dismissible fade show" role="alert"><strong>Terjadi kesalahan</strong>
                  ...
                  @endif
                <div class="card">
                    <form class="form theme-form" method="POST" enctype="multipart/form-data" action="{{ route('warga.update',$warga->id_warga)}}">
                        @csrf
                        @method('put')
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control" type="text" id="rt" name="rt" readonly placeholder="{{ old('rt',$warga->rt_rel->no_rt) }}">
                                            <input class="form-control" type="hidden" id="rt" name="rt" value="{{ old('rt',$warga->rt) }}">
                                        </div>
                                        <div class="col-sm-5">
                                            <input class="form-control " type="text" id="rw" name="rw" readonly placeholder="{{ old('rw',$warga->identitas_rws->no_rw) }}">
                                            <input class="form-control " type="hidden" id="rw" name="rw" value="{{ old('rw',$warga->rw) }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-5">
                                            <input class="form-control digits" name="tgl_lahir" value="{{ old('tgl_lahir',date_format($warga->tgl_lahir,"Y-m-d")) }}" id="tgl_lahir" type="date" data-bs-original-title="" title="">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control digits" name="tgl_perkawinan" type="date"  value="{{ old('tgl_perkawinan',$warga->tgl_perkawinan) }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control digits" name="tgl_keluar_kk" type="date"  value="{{ old('tgl_keluar_kk',date_format($warga->tgl_keluar_kk,"Y-m-d")) }}">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Foto Warga</label>
                                        <div class="col-sm-9"> 
                                            <img class="img-preview img-fluid mb-3 col-sm-5" src="{{ asset('storage/'.$warga->foto_warga) }}">
