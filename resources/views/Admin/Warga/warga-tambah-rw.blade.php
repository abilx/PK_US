                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-select select2" id="kabupaten" name="kabupaten">
                                                ...
                                                @foreach ($kabupaten as $pro)
                                                    <option value="{{ $pro->id_kap }}">{{ $pro->nama }}</option>
                                                @endforeach --}}
                                            </select>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-select select2" id="kecamatan" name="kecamatan">
                                                ...
                                                @foreach ($kecamatan as $pro)
                                                    <option value="{{ $pro->id_kec }}">{{ $pro->nama }}</option>
                                                @endforeach --}}
                                            </select>
                                        </div>
                                        <div class="col-sm-4">
                                            <select class="form-select select2" id="kelurahan" name="kelurahan">
                                                ...
                                                @foreach ($kelurahan as $pro)
                                                    <option value="{{ $pro->id_kel }}">{{ $pro->nama }}</option>
                                                @endforeach --}}
                                            </select>
                                        </div>
                                    </div>
