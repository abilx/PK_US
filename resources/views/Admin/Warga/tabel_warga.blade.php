                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="aksi">
                            ...
                            href="{{ route('warga.show',$dw->id_warga) }}"><span class="fa fa-eye"></span></a>
                            <a class="btn btn-secondary btn-sm p-2"
                            href="{{ route('warga.edit', $dw->id_warga) }}"><span class="fa fa-edit"></span></a>
                            <form method="POST"
                            action="{{ route('warga.destroy', $dw->id_warga) }}"
                            class="d-inline">
                            @csrf
                            <input name="_method"
                            type="hidden"
