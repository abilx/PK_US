...
@component('components.admin.breadcrumb')
        ...
        @endslot
        <li class="breadcrumb-item"><a href="{{ route('kategori_fasilitas.index') }}">Kategori fasilitas</a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <form class="form theme-form" name="f1" method="POST" action="{{route('kategori_fasilitas.update',$kategori_fasilitas->id_kategori_fasilitas)}}">
                        @method('put')
                        @csrf
