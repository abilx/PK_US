...
<head>
    ...
    <title>Profil Kelurahan | {{ $title }}</title>
    <!-- Google font-->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 footer-copyright">
                        <p class="mb-0">Copyright 2023-24 © Team Profil Kelurahan PCR.</p>
                    </div>
                    <div class="col-md-6">
                        <p class="pull-right mb-0">Innovillage2023 <i class="fa fa-heart font-secondary"></i></p>
                    </div>
                </div>
            </div>
        </footer>
