...
@section('container')
    @component('components.lurah.breadcrumb')
        ...
        <h3>Pengumuman</h3>
        @endslot
        <li class="breadcrumb-item"><a href="{{ route('warga.pengumuman.index') }}">Pengumuman</a></li>
	                ...
	                <div class="blog-box blog-shadow">
	                    ...
	                    <div class="blog-details">
							...
							<ul class="blog-social">
								...
								<li>Kategori: <a href="/Lurah/filter_kategori?category={{ $pengumuman[0]->kategori_pengumuman }}">{{ $pengumuman[0]->Kategori_pengumumans->nama_kategori_pengumuman }}</a></li>
							</ul>
							<hr />
							<article class="mt-0 text-light">{!! Str::limit($pengumuman[0]->isi_pengumuman, 100) !!}</article>
							<div class="mt-3 pull-right">
							<a href="{{route('warga.pengumuman.show',$pengumuman[0]->id_pengumuman)}}" class="btn btn-square btn-sm btn-secondary pull-right" type="button">Baca Selengkapnya</a>
							</div>
	                    </div>
	                </div>
	            </div>
	                        ...
	                        <div class="blog-box blog-list row">
	                            <div class="col-xl-6 col-12">
	                                <div class="blog-wrraper">
	                                    ...
	                                    <a href="{{route('warga.pengumuman.show',$k->id_pengumuman)  }}"><img class="img-fluid sm-100-wp p-0" src="{{asset('assets/images/blog/blog-2.jpg')}}" alt="" /></a>
										@else
										<a href="{{route('warga.pengumuman.show',$k->id_pengumuman)  }}"><img class="p-0" src="{{asset('storage/'. $k->foto_pengumuman)}}" width="316" height="225" alt="" /></a>
										@endif
	                                </div>
	                            </div>
	                            <div class="col-xl-6 col-12">
	                                <div class="blog-details">
	                                    ...
	                                    <a href="{{route('warga.pengumuman.show',$k->id_pengumuman)  }}"> <h6>{{ $k->nama_pengumuman }}</h6></a>
	                                    <div class="blog-bottom-content">
	                                        <ul class="blog-social">
	                                            <li>oleh: {{ $k->penanggung_jawab }}</li>
												<li>Kategori: <a href="/Lurah/filter_kategori?category={{$k->kategori_pengumuman}}">{{ $k->Kategori_pengumumans->nama_kategori_pengumuman }}</a></li>
	                                        </ul>
	                                        <hr />
	                                        <article class="mt-0 text-dark">{!! Str::limit($k->isi_pengumuman, 100) !!}.</article>
											<div class="pull-right">
												<a href="{{route('warga.pengumuman.show',$k->id_pengumuman)  }}" class="btn btn-square btn-sm btn-secondary pull-right" type="button">Baca Selengkapnya</a>
												</div>
	                                    </div>
	                                </div>
	                            </div>
	            ...
	            <div class="card">
	                <div class="blog-box blog-grid">
	                    <div class="blog-wrraper">
	                        ...
	                        <a href="{{route('warga.pengumuman.show',$kk->id_pengumuman)}}"><img class="p-0" src="{{asset('storage/'. $kk->foto_pengumuman)}}" width="421" height="263" alt="" /></a>
							@else
	                        <a href="{{route('warga.pengumuman.show',$kk->id_pengumuman)}}"><img class="img-fluid top-radius-blog" src="{{asset('assets/images/blog/blog-6.jpg')}}" alt="" /></a>
							@endif
	                    </div>
	                    <div class="blog-details-second">
							<div class="blog-date">{{ tanggal_indo($kk->tgl_terbit) }}</div>
	                        <a href="{{route('warga.pengumuman.show',$kk->id_pengumuman)}}"> <h6 class="blog-bottom-details">{{ $kk->nama_pengumuman }}</h6></a>
							<ul class="blog-social">
	                        ...
	                        <article class="mt-0 text-dark">{!! Str::limit($kk->isi_pengumuman, 100) !!}.</article>
								<a href="{{route('warga.pengumuman.show',$kk->id_pengumuman)}}" class="btn btn-square btn-sm btn-secondary pull-right mb-3 mt-3" type="button">Baca Selengkapnya</a>
	                    </div>
	                </div>
	            </div>
	        </div>
