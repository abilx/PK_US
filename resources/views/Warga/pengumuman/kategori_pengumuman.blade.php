...
@section('title')Kategori Kelurahan Umban Sari {{ $title }}
@endsection
...
<section class="unique-cards section-py-space">
    <div class="title">
        <h2>Katergori Pengumuman Kelurahan Umban Sari</h2>
    </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                                            ...
                                            <div class="blog-box blog-shadow">
                                                ...
                                                <div class="blog-details">
                                                    ...
                                                    <ul class="blog-social">
                                                        ...
                                                        <li>Kategori: <a href="/Lurah/filter_kategori?category={{ $pengumuman[0]->kategori_pengumuman }}">{{ $pengumuman[0]->Kategori_pengumumans->nama_kategori_pengumuman }}</a>
                                                        </li>
                                                    </ul>
                                                    <hr />
                                                    ...
                                                    <div class="blog-box blog-list row">
                                                        <div class="col-xl-6 col-12">
                                                            <div class="blog-wrraper">
                                                                ...
                                                                <a href="{{route('warga.pengumuman.show',$k->id_pengumuman)  }}">
                                                        ...
                                                        <div class="col-xl-6 col-12">
                                                            <div class="blog-details">
                                                                ...
                                                                <a href="{{route('warga.pengumuman.show',$k->id_pengumuman)  }}">
                                                                    <h6>{{ $k->nama_pengumuman }}</h6>
                                                                </a>
                                                                <div class="blog-bottom-content">
                                                                    <ul class="blog-social">
                                                                        <li>oleh: {{ $k->penanggung_jawab }}</li>
                                                                        <li>Kategori: <a href="/Lurah/filter_kategori?category={{$k->kategori_pengumuman}}">{{ $k->Kategori_pengumumans->nama_kategori_pengumuman }}</a>
                                                                        </li>
                                                                    </ul>
                                                                    <hr />
                                        ...
                                        <div class="card">
                                            <div class="blog-box blog-grid">
                                                <div class="blog-wrraper">
                                                    ...
                                                    <a href="{{route('warga.pengumuman.show',$kk->id_pengumuman)}}">
                                                ...
                                                <div class="blog-details-second">
                                                    ...
                                                    <a href="{{route('warga.pengumuman.show',$kk->id_pengumuman)}}">
                                                        <h6 class="blog-bottom-details">{{ $kk->nama_pengumuman }}</h6>
                                                    </a>
                                                    <ul class="blog-social">
                                                        <li>oleh: {{ $kk->penanggung_jawab }}</li>
                                                        <li>Kategori: <a href="/warga/filter_kategori?category={{ $kk->kategori_pengumuman }}">{{ $kk->Kategori_pengumumans->nama_kategori_pengumuman }}</a>
                                                        </li>
                                                    </ul>
                                                    <hr />
                            ...
                            </div> @else <div class="container-fluid blog-page">
                                <div class="feature-products">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="pro-filter-sec">
