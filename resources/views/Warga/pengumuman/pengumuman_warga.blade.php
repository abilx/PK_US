                        ...
                        <div class="blog-box blog-shadow">
                            ...
                            <div class="blog-details">
                                ...
                                <ul class="blog-social">
                                    ...
                                    <li>Kategori: <a
                                            href="/Lurah/pengumuman?category={{ $pengumuman[0]->kategori_pengumuman }}">{{ $pengumuman[0]->Kategori_pengumumans->nama_kategori_pengumuman }}</a>
                                    </li>
                                </ul>
                                <hr />
                                <article class="mt-0 text-light">{!! Str::limit($pengumuman[0]->isi_pengumuman, 100) !!}</article>
                                <div class="mt-3 pull-right">
                                    <a href="{{ route('lurah.pengumuman.show', $pengumuman[0]->id_pengumuman) }}"
                                        ...
                                        <div class="col-xl-6 col-12">
                                            <div class="blog-wrraper">
                                                @if ($k->foto_pengumuman == 'no-image.jpg')
                                                    <a
                                                        href="{{ route('lurah.pengumuman.show', $k->id_pengumuman) }}"><img
                                            ...
                                            <div class="blog-details">
                                                ...
                                                <div class="blog-bottom-content">
                                                    <ul class="blog-social">
                                                        ...
                                                        @endif
                                                        <li>Kategori: <a
                                                                href="/Lurah/pengumuman?category={{ $k->kategori_pengumuman }}">{{ $k->Kategori_pengumumans->nama_kategori_pengumuman }}</a>
                                                        </li>
                                                    </ul>
                                                    <hr />
                            ...
                            <div class="blog-box blog-grid">
                                <div class="blog-wrraper">
                                    @if ($kk->foto_pengumuman != 'no-image.jpg')
                                        <a href="{{ route('lurah.pengumuman.show', $kk->id_pengumuman) }}"><img
                                ...
                                <div class="blog-details-second">
                                    ...
                                    <ul class="blog-social">
                                        ...
                                        @endif
                                        <li>Kategori: <a
                                                href="/Lurah/pengumuman?category={{ $kk->kategori_pengumuman }}">{{ $kk->Kategori_pengumumans->nama_kategori_pengumuman }}</a>
                                        </li>
                                    </ul>
                                    <hr />
