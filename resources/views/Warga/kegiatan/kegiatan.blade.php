...
@section('title')Kegiatan Kelurahan Umban Sari {{ $title }}
@endsection
...
<section class="unique-cards section-py-space">
    <div class="title">
        <h2>Kegiatan Kelurahan Umban Sari</h2>
    </div>
                                            ...
                                            <div class="blog-box blog-shadow">
                                                ...
                                                <div class="blog-details">
                                                    ...
                                                    <ul class="blog-social">
                                                        ...
                                                        <li>Kategori: <a href="/ProfilKelurahanUmbanSari/kegiatan?category={{ $kegiatan[0]->kategori_kegiatan }}">{{ $kegiatan[0]->Kategori_kegiatans->kategori_kegiatan }}</a>
                                                        </li>
                                                    </ul>
                                                    <hr />
                                                    <article class="mt-0 text-light">{!! Str::limit($kegiatan[0]->isi_kegiatan, 100) !!}</article>
                                                    <div class="mt-3 pull-right">
                                                        <a href="{{ route('warga.kegiatan.show', $kegiatan[0]->id_kegiatan) }}" class="btn btn-sm btn-secondary pull-right" type="button">Baca Selengkapnya</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="blog-box blog-list row">
                                                        <div class="col-xl-6 col-12">
                                                            <div class="blog-wrraper">
                                                                ...
                                                                <a href="{{ route('warga.kegiatan.show', $k->id_kegiatan) }}">
                                                                    <img class="img-fluid sm-100-wp p-0" src="{{ asset('assets/images/blog/blog-2.jpg') }}" alt="" />
                                                                </a>
                                                                @else
                                                                <a href="{{ route('warga.kegiatan.show', $k->id_kegiatan) }}">
                                                                    <img class="p-0" src="{{ asset('storage/' . $k->foto_kegiatan) }}" width="316" height="260" alt="" />
                                                                </a>
                                                                @endif
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="blog-details">
                                                                ...
                                                                <div class="blog-bottom-content">
                                                                    <ul class="blog-social">
                                                                        ...
                                                                        @endif
                                                                        <li>Kategori: <a href="/Lurah/kegiatan?category={{ $k->kategori_kegiatan }}">{{ $k->Kategori_kegiatans->kategori_kegiatan }}</a>
                                                                        </li>
                                                                    </ul>
                                                                    <hr />
                                                                    <article class="mt-0 text-dark">{!! Str::limit($k->isi_kegiatan, 100) !!}</article>
                                                                    <div class="pull-right ">
                                                                        <a href="{{ route('warga.kegiatan.show', $k->id_kegiatan) }}" class="btn btn-sm btn-secondary pull-right my-3" type="button">Baca Selengkapnya</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="card">
                                            <div class="blog-box blog-grid">
                                                <div class="blog-wrraper">
                                                    ...
                                                    <a href="{{ route('warga.kegiatan.show', $kk->id_kegiatan) }}">
                                                ...
                                                <div class="blog-details-second">
                                                    ...
                                                    <ul class="blog-social">
                                                        ...
                                                        <li>oleh: RW {{ $k->rws->no_rw }}</li>
                                                        @endif
                                                        <li>Kategori: <a href="/Lurah/kegiatan?category={{ $kk->kategori_kegiatan }}">{{ $kk->Kategori_kegiatans->kategori_kegiatan }}</a>
                                                        </li>
                                                    </ul>
                                                    <hr />
                                                    <article class="mt-0 text-dark">{!! Str::limit($kk->isi_kegiatan, 100) !!}</article>
                                                    <a href="{{ route('warga.kegiatan.show', $kk->id_kegiatan) }}" class="btn btn-sm {{ $kk->penanggung_jawab == 'RT' ? 'btn-primary' : 'btn-secondary' }} pull-right mb-3 mt-3" type="button">Baca Selengkapnya</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
