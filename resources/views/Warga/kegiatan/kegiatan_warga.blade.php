                        ...
                        <div class="blog-box blog-shadow">
                            ...
                            <div class="blog-details">
                                ...
                                <ul class="blog-social">
                                    ...
                                    <li>Kategori: <a
                                            href="/Lurah/kegiatan?category={{ $kegiatan[0]->kategori_kegiatan }}">{{ $kegiatan[0]->Kategori_kegiatans->kategori_kegiatan }}</a>
                                    </li>
                                </ul>
                                <hr />
                                <article class="mt-0 text-light">{!! Str::limit($kegiatan[0]->isi_kegiatan, 100) !!}</article>
                                <div class="mt-3 pull-right">
                                    <a href="{{ route('lurah.kegiatan.show', $kegiatan[0]->id_kegiatan) }}"
                                    ...
                                    <div class="blog-box blog-list row">
                                        <div class="col-xl-6 col-12">
                                            <div class="blog-wrraper">
                                                @if ($k->foto_kegiatan == 'no-image.jpg')
                                                    <a
                                                        href="{{ route('lurah.kegiatan.show', $k->id_kegiatan) }}"><img
                                        ...
                                        <div class="col-xl-6 col-12">
                                            <div class="blog-details">
                                                ...
                                                <a href="{{ route('lurah.kegiatan.show', $k->id_kegiatan) }}">
                                                ...
                                                <div class="blog-bottom-content">
                                                    <ul class="blog-social">
                                                        ...
                                                        @endif
                                                        <li>Kategori: <a
                                                                href="/Lurah/kegiatan?category={{ $k->kategori_kegiatan }}">{{ $k->Kategori_kegiatans->kategori_kegiatan }}</a>
                                                        </li>
                                                    </ul>
                                                    <hr />
                            ...
                            <div class="blog-box blog-grid">
                                <div class="blog-wrraper">
                                    @if ($kk->foto_kegiatan != 'no-image.jpg')
                                        <a href="{{ route('lurah.kegiatan.show', $kk->id_kegiatan) }}"><img
                                ...
                                <div class="blog-details-second">
                                    ...
                                    <a href="{{ route('lurah.kegiatan.show', $kk->id_kegiatan) }}">
                                    ...
                                    <ul class="blog-social">
                                        ...
                                        @endif
                                        <li>Kategori: <a
                                                href="/Lurah/kegiatan?category={{ $kk->kategori_kegiatan }}">{{ $kk->Kategori_kegiatans->kategori_kegiatan }}</a>
                                        </li>
                                    </ul>
                                    <hr />
