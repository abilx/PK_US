...
<header class="main-nav">
    <div class="sidebar-user text-center">
        {{-- <a class="setting-primary" href="{{ route('warga.profilewarga.show',auth()->user()->_warga->id_warga) }}"><i data-feather="settings"></i></a>
        ...
        <a href="{{ route('warga.profilewarga.show',auth()->user()->_warga->id_warga) }}"> <h6 class="mt-3 f-14 f-w-600">{{ auth()->user()->nama_lengkap }}</h6></a>
        <p class="mb-0 font-roboto">RT {{ auth()->user()->_warga->rt }} RW {{auth()->user()->_warga->rw }}</p> --}}
        {{-- <ul>
            <li>
