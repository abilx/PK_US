                ...
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="bookmark">
                                    ...
                                    <a class="btn btn-primary btn-lg" href="{{ route('rw.wargamiskin.create') }}"
                    ...
                    <div class="card-body">
                        <div class="table-responsive overflow-hidden">
                            <table class="display" id="tabel-kemiskinan-rw">
                                <thead>
                                ...
                                <tbody>
                                    @foreach ($kemiskinan as $p)
                                        <tr>
                                            ...
                                            <td class="aksi">
                                                <a class="btn btn-info btn-sm p-2" href="{{ route('rw.warga.show_warga', $p->id) }}">
                                                    <span class="fa fa-eye"></span>
                                                </a>
                                                <form method="POST"
                                                    action="{{ route('rw.wargamiskin.destroy', $p->id) }}"
                                                    class="d-inline">
                                                    @csrf
