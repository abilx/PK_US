                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="bookmark">
                                    <a class="btn btn-primary btn-lg" href="{{ route('rw.warga.create') }}"
                    ...
                    <div class="card-body">
                        <div class="table-responsive overflow-hidden">
                            <table class="display" id="tabelwarga-rw">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="aksi">
                                                <a class="btn btn-info btn-sm p-2"
                                                    href="{{ route('rw.warga.show_warga', $dw->id_warga) }}"><span
                                                        class="fa fa-eye"></span></a>
                                                <a class="btn btn-secondary btn-sm p-2"
                                                    href="{{ route('rw.warga.edit', $dw->id_warga) }}"><span
