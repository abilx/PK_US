...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('fasilitas_umums', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('kategori_fasilitas_umum')
            ->index('fasilitas_umums_kategori_fasilitas_umum_foreign');
            $table->unsignedBigInteger('rt')->nullable()->index('fasilitas_umums_rt_foreign');
