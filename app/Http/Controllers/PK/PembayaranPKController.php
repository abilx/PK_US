...
class PembayaranPKController extends Controller
{
    public function index()
    {
        $pembayaran = pembayaran::all();

        return view('PetugasKelurahan.pembayaran.tabel_pembayaran', [
    ...
    {
        return view('PetugasKelurahan.pembayaran.edit_pembayaran', [
            'pembayaran' => $pembayaran,
    ...
    public function show($id)
    {
        ...
        return view('PetugasKelurahan.pembayaran.detail_pembayaran', [
            'pembayaran' => $pembayaran,
