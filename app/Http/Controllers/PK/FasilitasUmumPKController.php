...
class FasilitasUmumPKController extends Controller
{
    public function index()
    {
        // $fasilitas = Fasilitas_umum::where('status_fasilitas', 1)->get();
        // dd($fasilitas);
        return view('PetugasKelurahan.fasilitas.fasilitas_umum', [
    ...
    public function create()
    {
        ...
        return view('PetugasKelurahan.fasilitas.tambah_fasilitas', [
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['rw'] = auth()->user()->identitas_rw->rw;
        
        // dd(Fasilitas_umum::create($validatedData));
        try {
            Fasilitas_umum::create($validatedData);
            return redirect()->route('pk.fasilitas.index')
    ...
    {
        return view('PetugasKelurahan.fasilitas.edit_fasilitas', [
    ...
    public function update(Request $request, Fasilitas_umum $fasilitasrw)
    {
        ...
        return redirect()->route('pk.fasilitas.index')->with('success', 'Data berhasil diubah!');
    }
    ...
    public function show($id)
    {
        ...
        return view('PetugasKelurahan.fasilitas.detail_fasilitas', [
            'fasilitas' => $fasilitas,
