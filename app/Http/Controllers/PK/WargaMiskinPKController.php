...
class WargaMiskinPKController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // dd($kemiskinan);
        return view('PetugasKelurahan.Warga.kemiskinan.tabel_kemiskinan', [
    ...
    public function create()
    {
        ...
        return view('PetugasKelurahan.Warga.kemiskinan.tambah_kemiskinan');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (is_null($dataWargaSame)) {
            return redirect()->route('PetugasKelurahan.warga.kemiskinan.create')
        ...
        try {
            ...
            return redirect()->route('pk.warga.wargamiskin')
                ->with('success', 'Berhasil menambahkan data!');
        } catch (\Exception $e) {
            //mengembalikan ke halaman PetugasKelurahan.warga.kemiskinan.index dengan mengirimkan pesan
    ...
    public function show($kemiskinan)
    {
        ...
        return view('PetugasKelurahan.Warga.kemiskinan.detail_kemiskinan', [
            'kemiskinan' => $kemiskinan,
        ]);
    }
    ...
    public function show_warga(Request $request)
    {
        ...
        $jenazah = Warga::with('pekerjaans')->select('id_warga', 'nama_lengkap', 'jenis_kelamin', 'pekerjaan', 'agama', 'tempat_lahir', 'tgl_lahir', 'alamat', 'rt')
    ...
    public function requestSurat($kemiskinan)
    {
        ...
        if (!$dataKemiskinan) {
            return redirect()->route('PetugasKelurahan.warga.kematian.index')
        ...
        //    return view('PetugasKelurahan.warga.kematian.surat_kematian_pdf', ['kematian' => $dataKemiskinan]);
        // $pdf = PDF::loadview('PetugasKelurahan.warga.kematian.surat_kematian_pdf', ['kematian' => $dataKemiskinan]);
        // return $pdf->stream();
    }
