...
class PengumumanPKController extends Controller
{
    public function index()
    {
        $pengumuman = Pengumuman::all();

        return view('PetugasKelurahan.Pengumuman.tabel_pengumuman', [
    ...
    public function create()
    {
        ...
        return view('PetugasKelurahan.Pengumuman.tambah_pengumuman', [
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['penanggung_jawab'] = 'Petugas Kelurahan';
        $validatedData['id_penanggung_jawab'] = auth()->id();

        try {
            Pengumuman::create($validatedData);

            return redirect()->route('pk.pengumuman.index')
    ...
    {
        return view('PetugasKelurahan.Pengumuman.edit_pengumuman', [
            'pengumuman' => $pengumuman,
            'kategori_pengumuman' => KategoriPengumuman::all(),
    ...
    public function update(Request $request, Pengumuman $pengumuman)
    {
        ...
        $validatedData['status_pengumuman'] = 1;
        $validatedData['penanggung_jawab'] = 'PetugasKelurahan';
        $validatedData['id_penanggung_jawab'] = auth()->id();
        ...
        return redirect()->route('pk.pengumuman.index')->with('success', 'Data berhasil diubah!');
    }
    ...
    public function show($id)
    {
        ...
        // dd($pengumuman);
        return view('PetugasKelurahan.Pengumuman.detail_pengumuman', [
            'pengumuman' => $pengumuman,
