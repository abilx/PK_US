...
class ProfileLurahController extends Controller
{
     ...
     public function show($id)
    {
        ...
        return view('Lurah.ProfileLurah.profile-lurah-tes', [
    ...
    public function edit(PK $profile)
    {
        ...
        return view('Lurah.ProfileLurah.edit_profile', [
    ...
    public function update(Request $request, Warga $warga)
    {
        ...
        if ($request->username) {
            ...
            return redirect()->route('lurah.profile.show', $request->id)->with('success', 'Username berhasil diubah!');
        }
        ...
        if ($request->password) {
            ...
            User::where('id', $request->user_id)
                ->update($validatedData);
            return redirect()->route('lurah.profile.show', $request->id)->with('success', 'Password berhasil diubah!');
        }
        ...
        warga::where('id_warga', $warga->id_warga)
            ->update($validatedData);
        return redirect()->route('lurah.profile.show', $request->id)->with('success', 'Data berhasil diubah!');
    }
}
