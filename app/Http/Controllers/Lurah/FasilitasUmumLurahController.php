...
class FasilitasUmumLurahController extends Controller
{
    public function index()
    {
        // $fasilitas = Fasilitas_umum::where('status_fasilitas', 1)->get();
        // dd($fasilitas);
        return view('Lurah.fasilitas.fasilitas_umum', [
    ...
    public function create()
    {
        ...
        return view('Lurah.fasilitas.tambah_fasilitas', [
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['lurah'] = auth()->user()->id_lurah;

        try {
            Fasilitas_umum::create($validatedData);
            return redirect()->route('lurah.fasilitasrw.index')
    ...
    {
        return view('Lurah.fasilitas.edit_fasilitas', [
    ...
    public function update(Request $request, Fasilitas_umum $fasilitasrw)
    {
        ...
        return redirect()->route('lurah.fasilitasrw.index')->with('success', 'Data berhasil diubah!');
    }
    ...
    public function show($id)
    {
        ...
        return view('Lurah.fasilitas.detail_fasilitas', [
            'fasilitas' => $fasilitas,
