...
class WargaMiskinLurahController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // dd($kemiskinan);
        return view('Lurah.Warga.kemiskinan.tabel_kemiskinan', [
    ...
    public function create()
    {
        ...
        return view('Lurah.Warga.kemiskinan.tambah_kemiskinan');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (is_null($dataWargaSame)) {
            return redirect()->route('Lurah.warga.kemiskinan.create')
        ...
        try {
            ...
            return redirect()->route('lurah.warga.wargamiskin')
                ->with('success', 'Berhasil menambahkan data!');
        } catch (\Exception $e) {
            //mengembalikan ke halaman Lurah.warga.kemiskinan.index dengan mengirimkan pesan
    ...
    public function show($kemiskinan)
    {
        ...
        return view('Lurah.Warga.kemiskinan.detail_kemiskinan', [
            'kemiskinan' => $kemiskinan,
        ]);
    }
    ...
    public function requestSurat($kemiskinan)
    {
        ...
        if (!$dataKemiskinan) {
            return redirect()->route('Lurah.Warga.kematian.index')
        ...
        //    return view('Lurah.warga.kematian.surat_kematian_pdf', ['kematian' => $dataKemiskinan]);
        // $pdf = PDF::loadview('Lurah.warga.kematian.surat_kematian_pdf', ['kematian' => $dataKemiskinan]);
        // return $pdf->stream();
    }
