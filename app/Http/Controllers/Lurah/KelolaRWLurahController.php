...
class KelolaRWLurahController extends Controller
{
    ...
    public function index()
    {
        ...
        // dd($kelola_rw);
        return view('Lurah.Kelola_rtrw.kelola_rtrw', [
            'kelola_rw' => $kelola_rw,
            "title" => "Daftar RW"
        ]);
    }
    ...
    {
        $rw = Warga::all();
        return view('Lurah.Kelola_rtrw.rw.tambah_rw', [
            'title' => 'tambah RW',
            'rw' => $rw
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('Lurah.rw.index')
    ...
    public function edit(rw $rw)
    {
        ...
        return view('Lurah.Kelola_rtrw.rw.edit_rw', [
            'rw' => $rw,
            'kelola_rw' => $kelola_rw,
            'user' => $user,
            'title' => 'edit-rw'
    ...
    public function show($id)
    {
        ...
        // dd($kelola_rw);
        return view('Lurah.Kelola_rtrw.rw.detail_rw', [
            // 'kelola_rw' => $kelola_rw,
