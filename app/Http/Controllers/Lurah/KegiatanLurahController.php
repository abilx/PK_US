...
class KegiatanLurahController extends Controller
{
    public function index()
    {
        $kegiatan = Kegiatan::all();

        return view('Lurah.kegiatan.tabel_kegiatan', [
            'kegiatan' => $kegiatan,
    ...
    public function create()
    {
        ...
        return view('Lurah.kegiatan.tambah_kegiatan', [
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('lurah.kegiatan.index')
    ...
    {
        return view('Lurah.kegiatan.edit_kegiatan', [
            'kegiatan' => $kegiatan,
            'kategori_kegiatan' => KategoriKegiatan::all(),
            'title' => 'edit-kegiatan'
        ]);
    ...
    public function update(Request $request, Kegiatan $kegiatan)
    {
        ...
        return redirect()->route('lurah.kegiatan.index')->with('success', 'Data berhasil diubah!');
    }
    ...
    public function show($id)
    {
        try {
            ...
            return view('Lurah.kegiatan.detail_kegiatan', [
                'kegiatan' => $kegiatan,
