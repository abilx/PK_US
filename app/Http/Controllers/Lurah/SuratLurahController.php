...
class SuratLurahController extends Controller
{
    ...
    public function nomorsurat()
    {
        ...
        // dd($surat);
        // return $surat;
        return view('Lurah.surat.nomor_surat', [
            'surat' => $surat,
    ...
    public function detailSuratKeterangan(Surat $surat)
    {
        $surat = $surat;
        $title = "Pengajuan Surat";
        return view('Lurah.surat.surat_keterangan_detail', compact('surat', 'title'));
    }
    public function prosesSurat(Request $request, Surat $surat)
    {
        ...
        if ($proses == 'terima') {
            ...
            return redirect()->route('lurah.surat.index')->with('success', 'Surat telah disetuji!');
        } elseif ($proses == 'tolak') {
            $this->tolakSuratKeterangan($surat);
            return redirect()->route('lurah.surat.index')->with('success', 'Surat ditolak!');
        }
    }
    ...
    public function printSuratKeterangan(Surat $surat)
    {
        ...
        if (!$surat and $surat->status_surat == 0) {
            return redirect()->route('lurah.surat.index')
    ...
    public function cekSurat()
    {
        ...
        return view('lurah.surat.cek_surat');
