...
class PembayaranLurahController extends Controller
{
    public function index()
    {
        $pembayaran = pembayaran::all();

        return view('Lurah.pembayaran.tabel_pembayaran', [
    ...
    {
        return view('Lurah.pembayaran.edit_pembayaran', [
            'pembayaran' => $pembayaran,
    ...
    public function show($id)
    {
        ...
        return view('Lurah.pembayaran.detail_pembayaran', [
            'pembayaran' => $pembayaran,
