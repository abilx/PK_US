...
class PengumumanLurahController extends Controller
{
    public function index()
    {
        $pengumuman = Pengumuman::all();

        return view('Lurah.Pengumuman.tabel_pengumuman', [
    ...
    public function create()
    {
        ...
        return view('Lurah.Pengumuman.tambah_pengumuman', [
    ...
    public function store(Request $request)
    {
        ...
        $validatedData['penanggung_jawab'] = 'Lurah';
        $validatedData['id_penanggung_jawab'] = auth()->id();

        try {
            Pengumuman::create($validatedData);

            return redirect()->route('lurah.pengumuman.index')
    ...
    {
        return view('Lurah.Pengumuman.edit_pengumuman', [
            'pengumuman' => $pengumuman,
            'kategori_pengumuman' => KategoriPengumuman::all(),
    ...
    public function update(Request $request, Pengumuman $pengumuman)
    {
        ...
        return redirect()->route('lurah.pengumuman.index')->with('success', 'Data berhasil diubah!');
    }
    ...
    public function show($id)
    {
        ...
        // dd($pengumuman);
        return view('Lurah.Pengumuman.detail_pengumuman', [
            'pengumuman' => $pengumuman,
