...
use App\Http\Controllers\Admin\wargaAdminController as WargaController;
...
class WargaControllerTest extends TestCase
{
    ...
    public function testIndexWarga()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'Admin.Warga.tabel_warga'
        $this->assertEquals('Admin.Warga.tabel_warga', $response->name());
    ...
    public function testCreateWarga()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'Admin.Warga.tambah_warga'
        $this->assertEquals('Admin.Warga.warga-tambah-rw', $response->name());
    ...
    public function testStoreWarga()
    {
        ...
        $this->assertEquals(route('warga.index'), $response->getTargetUrl());
    ...
    public function testEditWarga()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'Admin.Warga.edit_warga'
        $this->assertEquals('Admin.Warga.warga-edit-rw', $response->name());
    ...
    public function testShowWarga()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'Admin.Warga.detail_warga'
        $this->assertEquals('Admin.Warga.detail_warga', $response->name());
