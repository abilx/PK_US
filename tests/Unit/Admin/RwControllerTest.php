...
use App\Http\Controllers\Admin\KelolaRWController as RWController;
use App\Models\rw;
use App\Models\User;
...
class RWControllerTest extends TestCase
{
    ...
    public function testIndexRw()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'Admin.Kelola_rtrw.rw.tabel_rw'
        $this->assertEquals('Admin.Kelola_rtrw.rw.tabel_rw', $response->name());
    ...
    public function testCreateRw()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'Admin.Kelola_rtrw.rw.tambah_rw'
        $this->assertEquals('Admin.Kelola_rtrw.rw.tambah_rw', $response->name());
    ...
    public function testStoreRw()
    {
        ...
        $this->assertEquals(route('rw.index'), $response->getTargetUrl());
    ...
    public function testEditRw()
    {
        ...
        $this->assertEquals('Admin.Kelola_rtrw.rw.edit_rw', $response->name());
    ...
    public function testShowRw()
    {
        ...
        $this->assertEquals('Admin.Kelola_rtrw.rw.detail_rw', $response->name());
