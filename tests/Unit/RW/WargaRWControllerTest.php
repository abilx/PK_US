...
use App\Http\Controllers\RW\wargaRWController as WargaController;
...
class WargaRWControllerTest extends TestCase
{
    ...
    public function testIndexWarga()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'RW.Warga.tabel_warga'
        $this->assertEquals('RW.Warga.warga', $response->name());
    ...
    public function testWargaRw()
    {
        ...
        $this->assertEquals('RW.Warga.tabel_warga', $response->name());
    ...
    public function testWargaLansia()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'Lurah.Warga.tabel_warga'
        $this->assertEquals('RW.Warga.warga-rw-lansia', $response->name());
    ...
    public function testWargaKepala()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'Lurah.Warga.tabel_warga'
        $this->assertEquals('RW.Warga.warga-rw-kepala', $response->name());
    ...
    public function testCreateWarga()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'RW.Warga.tambah_warga'
        $this->assertEquals('RW.Warga.warga-tambah-rw', $response->name());
    ...
    public function testStoreWarga()
    {
        ...
        $this->assertEquals(route('rw.warga.index'), $response->getTargetUrl());
    ...
    public function testEditWarga()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'RW.Warga.edit_warga'
        $this->assertEquals('RW.Warga.warga-edit-rw', $response->name());
    ...
    public function testShowWarga()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'RW.Warga.detail_warga'
        $this->assertEquals('RW.Warga.detail_warga', $response->name());
