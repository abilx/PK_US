...
use App\Http\Controllers\RW\ProfileRWController as ProfileController;
use App\Models\User;
...
class ProfileRWControllerTest extends TestCase
{
    ...
    public function testEditRw()
    {
        ...
        $this->assertEquals('RW.profileRW.edit_profile', $response->name());
    ...
    public function testUpdateRw()
    {
        ...
        $this->assertEquals(route('rw.profile.show', $rw->id_rw), $response->getTargetUrl());
    ...
    public function testUpdateUsername()
    {
        ...
        $this->assertEquals(route('rw.profile.show', $user->id), $response->getTargetUrl());
    ...
    public function testShowRw()
    {
        ...
        $this->assertEquals('RW.ProfileRW.profile-rw-tes', $response->name());
