...
use App\Http\Controllers\RW\PengaduanRWController as PengaduanController;
...
class PengaduanRWControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function testIndexPengaduan()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'RW.pengaduan.tabel_pengaduan'
        $this->assertEquals('RW.Pengaduan.tabel_pengaduan', $response->name());
