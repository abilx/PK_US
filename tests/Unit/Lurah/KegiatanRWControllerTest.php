...
use App\Http\Controllers\Warga\KegiatanWargaController as KegiatanController;
...
class KegiatanLurahControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function testIndexKegiatan()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'Lurah.Kegiatan.tabel_kegiatan'
        $this->assertEquals('Warga.kegiatan.kegiatan_warga', $response->name());
    ...
    public function testShowKegiatan()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'Lurah.Kegiatan.detail_kegiatan'
        $this->assertEquals('Warga.kegiatan.detail_kegiatan_warga', $response->name());
