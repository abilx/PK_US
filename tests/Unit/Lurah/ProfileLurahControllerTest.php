...
use App\Http\Controllers\Lurah\ProfileLurahController as ProfileController;
use App\Models\User;
...
class ProfileLurahControllerTest extends TestCase
{
    ...
    public function testEditLurah()
    {
        ...
        $this->assertEquals('Lurah.ProfileLurah.edit_profile', $response->name());
     ...
     * @return void
     */
    public function testUpdateLurah()
    {
        // Membuat data rw palsu
        $pk = PK::factory()->create();
        ...
        $this->assertEquals(route('lurah.profile.show', $pk->id_pk), $response->getTargetUrl());
    ...
    public function testUpdateUsername()
    {
        ...
        $this->assertEquals(route('lurah.profile.show', $user->id), $response->getTargetUrl());
    ...
    public function testShowLurah()
    {
        ...
        $this->assertEquals('Lurah.ProfileLurah.profile-lurah-tes', $response->name());
