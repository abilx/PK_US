...
//     {
//         $response = $this->get(route('pk.rt.index'));

//         $response->assertStatus(200);
//         $response->assertViewIs('PetugasKelurahan.Kelola_rtrw.rt.tabel_rt');
...
//     {
//         $response = $this->get(route('pk.rt.create'));

//         $response->assertStatus(200);
//         $response->assertViewIs('PetugasKelurahan.Kelola_rtrw.rt.tambah_rt');
...
//         $response = $this->post(route('pk.rt.store'), $data);
...
//         $response->assertRedirect(route('pk.rt.index'));
...
//         $response = $this->get(route('pk.rt.edit', $rt));

//         $response->assertStatus(200);
//         $response->assertViewIs('PetugasKelurahan.Kelola_rtrw.rt.edit_rt');
...
//         $response = $this->put(route('pk.rt.update', $rt), $data);
...
//         $response = $this->delete(route('pk.rt.destroy', $rt));
...
//         $response = $this->get(route('pk.rt.show', $rt->id_rt));
//         // $response->ddSession();
//         $response->assertStatus(200);
//         $response->assertViewIs('PetugasKelurahan.Kelola_rtrw.rt.detail_rt');
...
//     //     $response = $this->json('POST', route('pk.rt.updateStatus'), $data);
...
use App\Http\Controllers\PK\KelolaRTPKController as RtController;
use App\Models\rt;
use App\Models\User;
use Illuminate\Foundation\Testing\RefreshDatabase;
...
class RtPKControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function testIndexRt()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'PetugasKelurahan.Kelola_rtrw.rt.tabel_rt'
        $this->assertEquals('PetugasKelurahan.Kelola_rtrw.rt.tabel_rt', $response->name());
    ...
    public function testCreateRt()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'PetugasKelurahan.Kelola_rtrw.rt.tambah_rt'
        $this->assertEquals('PetugasKelurahan.Kelola_rtrw.rt.tambah_rt', $response->name());
    ...
    public function testStoreRt()
    {
        ...
        // Memastikan bahwa redirect route adalah 'pk.rt.index'
        $this->assertEquals(route('pk.rt.index'), $response->getTargetUrl());
    ...
    public function testEditRt()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'PetugasKelurahan.Kelola_rtrw.rt.edit_rt'
        $this->assertEquals('PetugasKelurahan.Kelola_rtrw.rt.edit_rt', $response->name());
    ...
    public function testShowRt()
    {
        ...
        // Memastikan bahwa view yang digunakan adalah 'PetugasKelurahan.Kelola_rtrw.rt.detail_rt'
        $this->assertEquals('PetugasKelurahan.Kelola_rtrw.rt.detail_rt', $response->name());
