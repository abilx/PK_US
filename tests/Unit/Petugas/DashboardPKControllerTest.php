...
class DashboardPKControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function testHomePetugas()
    {

        // Execute the controller method
        $response = $this->get(route('pk.dashboard.home'));

        // Assert the response
        $response->assertStatus(200)
            ->assertViewIs('PetugasKelurahan.Dashboard.home')
            ->assertViewHasAll([
                'warga',
                'wargaw',
